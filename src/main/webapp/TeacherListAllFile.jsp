...
<div class="panel panel-info col-md-offset-1 col-md-10">
    ...
    <div class="panel-body">
        <c:forEach var="me" items="${fileNameMap}" >
            <div class="panel panel-success col-md-12">
                <div class="panel-body">
                    ...
                    <c:url value="/DeleteServlet.do" var="deleteurl">
                        <c:param name="filename" value="${me.key}"></c:param>
                    </c:url>
                        ...
                        <a href="${downurl}">下载</a>&nbsp;
                        &nbsp;&nbsp;
                        <a onclick='delcfm()' href="${deleteurl}" onMouseOver = "this.style.color = 'red'" onMouseOut = "this.style.color = ''  "><blink>删除</blink></a>
                    <br/>
                </div>
            </div>
        ...
        <div class="panel panel-success col-md-12">
            <div class="panel-body">
                <a href="TeacherUpLoadFile.jsp"><h2 align="center" >+</h2> </a>
            </div>
        </div>
